  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学生状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择学生状态" clearable>
          <el-option
            v-for="dict in dict.type.enable_state"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['main:student:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['main:student:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学生状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.enable_state" :value="scope.row.status"/>
        </template>
      </el-table-column>
...
<script>
import { listStudent, getStudent, delStudent, addStudent, updateStudent } from "@/api/main/student";

export default {
  name: "Student",
  dicts: ['enable_state', 'sys_user_sex'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('main/student/export', {
        ...this.queryParams
